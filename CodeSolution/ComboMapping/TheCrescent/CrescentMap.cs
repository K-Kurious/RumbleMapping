...
using BuildInfo = TheCrescent.BuildInfo;

[assembly: MelonInfo(typeof(TheCrescent.CrescentMap), BuildInfo.Name, BuildInfo.Version, BuildInfo.Author, BuildInfo.DownloadLink)]
[assembly: MelonGame(null, null)]

namespace TheCrescent
{

    public static class BuildInfo
    {
        public const string Name = "The Crescent";
        public const string Description = "A huge desolate Island";
        public const string Author = "CretinousCrustacean & SisterPankake";
        public const string Company = null;
        public const string Version = "1.0.0";
        public const string DownloadLink = null;
    }

    public class CrescentMap: Map
    {
        ...
        {
            // Load and assign Map
            Il2CppAssetBundle bundle = LoadBundle("TheCrescent.Resources.");
            arena = GameObject.Instantiate(bundle.LoadAsset<GameObject>(""));
